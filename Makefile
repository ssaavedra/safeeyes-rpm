...
TARGETS = i386/safeeyes-$(VERSION)-$(RELEASE).i386.rpm x86_64/safeeyes-$(VERSION)-$(RELEASE).x86_64.rpm safeeyes-$(VERSION)-$(RELEASE).src.rpm
...
rpm: i386/safeeyes-$(VERSION)-$(RELEASE).i386.rpm x86_64/safeeyes-$(VERSION)-$(RELEASE).x86_64.rpm

i386/safeeyes-$(VERSION)-$(RELEASE).i386.rpm: v$(VERSION).tar.gz safeeyes.spec
...
x86_64/safeeyes-$(VERSION)-$(RELEASE).x86_64.rpm: v$(VERSION).tar.gz safeeyes.spec
...
SRPM: safeeyes-$(VERSION)-$(RELEASE).src.rpm

safeeyes-$(VERSION)-$(RELEASE).src.rpm: v$(VERSION).tar.gz safeeyes.spec
